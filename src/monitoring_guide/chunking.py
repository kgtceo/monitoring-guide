...
Chunk size and overlap materially change retrieval quality, which is exactly why
the eval harness compares configurations. This splitter is word-based with overlap:
